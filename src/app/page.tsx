        ...
        <header className="sticky top-0 z-10 w-full border-b border-slate-200 bg-gradient-to-r from-white via-blue-50 to-white shadow-sm">
          <div className="flex h-16 items-center px-4 gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0 p-2.5 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 shadow-lg hover:shadow-xl transition-shadow">
                <Logo />
              </div>
              <div className="flex flex-col justify-center">
                <h1 className="text-xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent leading-tight">
                  Collegewala
                </h1>
                <p className="text-sm text-slate-500 font-medium">AI College Assistant</p>
              </div>
            </div>
          </div>
        </header>
